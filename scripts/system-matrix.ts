...
process.stdout.write(
	...
	`specialist_edges=${specialistEdges} negative_terminals=2 novelty_holds=1 failure_injections=26 state_sources=python+typescript package=${packageJson.version} ` +
